    ...
    namespace games
    {
        ...
        public:
            ...
            float getReward() override
            {
                ...
                float dist_change = dist_to_hole(current_ram_ptr_) - dist_to_hole(previous_ram_.data());
                ...
                reward -= std::min(dist_change, 0.0f);
                reward -= strokes_change * 1000.0f;
                reward -= std::max(score_change, 0) * 10.0f;
                reward += hole_change * 10000.0f;
