...
def run_test():
    ...
    try:
        ...
        envs = HCLEVectorEnv(game="smb1", num_envs=num_envs, obs_width=256, obs_height=240)
    ...
    envs.close()
    print("\n--- Test Complete ---")
    print(f"Executed {num_steps*num_envs} frames in {duration:.2f} seconds ({fps:.2f} FPS).")
